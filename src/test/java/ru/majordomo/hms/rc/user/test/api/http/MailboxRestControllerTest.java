        ...
        mockMvc.perform(request).andExpect(status().isOk())
                ...
                .andDo(doc.document(
                        responseFields(
                                ...
                                fieldWithPath("blackListInPunycode").description("Список адресов в punycode, почта с которых не должна доставляться"),
                                fieldWithPath("whiteListInPunycode").description("Список адресов в punycode, с которых почта должна доставляться в любом случае"),
                                fieldWithPath("redirectAddressesInPunycode").description("Список переадресаций с текущего почтового ящика в punycode "),
